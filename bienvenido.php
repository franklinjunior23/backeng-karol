    ...
    <div class="contenedor-responsive">
        <div>
            <div class="links-contn-bn">
                <ul>
                    <li id="active-bn"><a href="bienvenido.php"><span></span>Bienvenido</a></li>
                    <li><a href="palabrasdirector.php"><span></span>Palabras del Director</a></li>
                    <li><a href="mision.php"><span></span>Mision y Vision</a></li>
                </ul>
            </div>
            <div class="cntn-text-bn">
                <h2>Somos la gran familia Wojtyliano</h2>
                <p>
                ...
                <img src="../img/header/bienvenidos.jpg" alt="">
            </div>
        </div>
    </div>
</section>
